...
const scratchDir = '/tmp/claude-0/-home-user-kidsportal/d8701608-4d4a-5b8b-b3a6-164292397e98/scratchpad/content';
            ...
            tasks: [
                {
                    ...
                    taskName: `Lesson: ${level.levelName.replace(/^Level \d+:\s*/, '')}`,
                    type: 'lesson',
...
console.log(`Merged real curriculum content into ${updatedSubjects} subjects (${updatedLevels} levels).`);
