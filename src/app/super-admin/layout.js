                    ...
                    <div className="flex flex-col h-full">
                        ...
                        <div className="p-6 border-b border-slate-800/50 flex items-center justify-between">
                            <Link href="/super-admin" className="flex items-center gap-3">
                                ...
                                {sidebarOpen && <span className="font-black tracking-tighter text-xl">KIDS<span className="text-blue-500">PORTAL</span></span>}
                            </Link>
                        </div>
                        ...
                        {sidebarOpen && (
                            <div className="px-6 py-3 border-b border-slate-800/30">
                                <span className="text-[9px] font-black uppercase tracking-[3px] text-blue-500 bg-blue-500/10 px-3 py-1.5 rounded-full border border-blue-500/20">
                                    Super Admin
                                </span>
                            </div>
                        )}
                ...
                <div className={`flex-grow flex flex-col transition-all duration-300 ${sidebarOpen ? 'ml-64' : 'ml-20'}`}>
                    ...
                    <header className="h-20 border-b border-slate-800 bg-slate-900/50 backdrop-blur-md flex items-center justify-between px-8 sticky top-0 z-40">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-blue-600 to-violet-600 border-2 border-slate-700 flex items-center justify-center font-black text-white overflow-hidden text-sm">
