...
import mathLevels from '../../components/buildLab/mathLevels';
  ...
  return (
    <div className="flex flex-col p-2 sm:p-4 relative font-sans">
      ...
      <div className="px-4 py-8">
        ...
        >
          <div className="inline-flex items-center gap-2 bg-blue-100 text-blue-700 px-5 py-2 rounded-full text-sm font-black uppercase tracking-wider mb-4">
            <FaCalculator /> Build Lab
          </div>
          <h1 className="text-4xl md:text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-cyan-600 drop-shadow-sm">
            Tap Tiles, Build Equations!
          </h1>
          <p className="text-slate-500 font-medium mt-3 max-w-xl mx-auto">
            Tap numbers and symbols to build an equation that equals the target.
          </p>
        </motion.div>

        <TileBuilder levels={mathLevels} accent="blue" promptLabel="Build an equation" />
      </div>
    </div>
  );
}
