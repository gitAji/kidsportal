...
const LessonViewer = dynamic(
  () => import("../../../../components/learning/LessonViewer"),
  { ssr: false }
);
const QuizTaker = dynamic(
  () => import("../../../../components/learning/QuizTaker"),
  { ssr: false }
);
const ExamTaker = dynamic(
  () => import("../../../../components/learning/ExamTaker"),
  { ssr: false }
);
const TaskViewer = dynamic(
  () => import("../../../../components/learning/TaskViewer"),
  { ssr: false }
);
        ...
        level1: [
          ...
          },
          {
            ...
            questions: [
              ...
              {
                id: "q2",
                questionText: "Count the number of wheels on a car.",
                options: ["2", "3", "4"],
                correctAnswer: "4",
              },
            ],
        ...
        <section className="py-20 bg-gray-50">
          <div className="container mx-auto text-center px-4">
            ...
            <p className="mt-4 text-gray-600">
              No learning content available for{" "}
