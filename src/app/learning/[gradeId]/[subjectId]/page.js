    ...
    <>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto text-center px-4">
          <h1 className="text-4xl font-bold text-blue-600">{subjectId.charAt(0).toUpperCase() + subjectId.slice(1)} - {gradeId.replace('grade', 'Grade ')}</h1>
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {levels.map((level) => (
              <div
                ...
                onClick={() => router.push(`/learning/${gradeId}/${subjectId}/${level.id}`)}
              >
