                ...
                >
                    ...
                    {error === "TEACHER_PROHIBITED" ? (
                        ...
                        >
                            <div className="flex gap-4">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-amber-800/70 text-sm font-medium leading-relaxed mb-4 text-left">
                                        Your account is active as a Teacher. Please use the educator portal for access.
                                    </p>
                                    <button
                                        onClick={() => router.push('/teacher-admin/login')}
                                        className="bg-amber-600 text-white px-6 py-2.5 rounded-xl font-bold text-xs uppercase tracking-widest hover:bg-amber-700 transition-all flex items-center justify-center gap-2 w-full sm:w-auto"
                                    >
                        ...
                        >
                            ...
                            <span className="text-rose-600 text-sm font-bold italic">{error}</span>
                        </motion.div>
                    ) : null}
