...
const faqData = [
  {
    ...
    answer:
      "Parents can easily register for an account using their email or Google. Once registered, they can access a dedicated parent dashboard to add and manage multiple child profiles. Each child profile can be customized with unique login credentials or a permanent access link, making it simple for children to get started.",
  },
  {
    id: "child-login",
    icon: faChild,
